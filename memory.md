...
Durable lessons and state for Potoos that are not obvious from the code.
...
- Verify any deploy: `https://akircyno.github.io/potoos/assets/env.properties`
  must be 200 with non-empty values. Keep this in mind for any future URL or
...
- Live beta: `https://akircyno.github.io/potoos/`.
